...
const skills = () => {
  return (
    <section
      id="skills"
      className="skills-wrapper flex flex-col justify-start items-center h-screen text-white px-20 pt-36"
    >
      ...
      <div className="skills-list grid justify-center items-center gap-10 pt-12 text-stone-500 tracking-wider h-fit">
